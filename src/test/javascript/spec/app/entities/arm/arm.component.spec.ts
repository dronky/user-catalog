...
import { ArmComponent } from 'app/entities/arm/arm.component';
import { ArmService } from 'app/entities/arm/arm.service';
import { Arm } from 'app/shared/model/arm.model';

describe('Component Tests', () => {
  describe('Arm Management Component', () => {
    let comp: ArmComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.arms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
