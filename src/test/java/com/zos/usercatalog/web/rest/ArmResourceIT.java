...
public class ArmResourceIT {
    ...
    private static final String DEFAULT_ADDITIONAL_IP = "AAAAAAAAAA";
    private static final String UPDATED_ADDITIONAL_IP = "BBBBBBBBBB";
    ...
    public static Arm createEntity(EntityManager em) {
        Arm arm = new Arm()
            ...
            .additionalIp(DEFAULT_ADDITIONAL_IP);
        return arm;
    }
    /**
    ...
    public static Arm createUpdatedEntity(EntityManager em) {
        Arm arm = new Arm()
            ...
            .additionalIp(UPDATED_ADDITIONAL_IP);
        return arm;
    }
    ...
    public void createArm() throws Exception {
        ...
        assertThat(testArm.getAdditionalIp()).isEqualTo(DEFAULT_ADDITIONAL_IP);
    ...
    public void getAllArms() throws Exception {
        ...
        restArmMockMvc.perform(get("/api/arms?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].additionalIp").value(hasItem(DEFAULT_ADDITIONAL_IP.toString())));
    }
    ...
    public void getArm() throws Exception {
        ...
        restArmMockMvc.perform(get("/api/arms/{id}", arm.getId()))
            ...
            .andExpect(jsonPath("$.additionalIp").value(DEFAULT_ADDITIONAL_IP.toString()));
    }
    ...
    public void updateArm() throws Exception {
        ...
        assertThat(testArm.getAdditionalIp()).isEqualTo(UPDATED_ADDITIONAL_IP);
    ...
    public void searchArm() throws Exception {
        ...
        restArmMockMvc.perform(get("/api/_search/arms?query=id:" + arm.getId()))
            ...
            .andExpect(jsonPath("$.[*].additionalIp").value(hasItem(DEFAULT_ADDITIONAL_IP)));
    }
