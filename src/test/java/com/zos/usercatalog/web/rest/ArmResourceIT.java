...
public class ArmResourceIT {
    ...
    private static final String DEFAULT_PROD_IP = "AAAAAAAAAA";
    private static final String UPDATED_PROD_IP = "BBBBBBBBBB";

    private static final String DEFAULT_EXTRA_PROD_IP = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_PROD_IP = "BBBBBBBBBB";

    private static final String DEFAULT_TEST_IP = "AAAAAAAAAA";
    private static final String UPDATED_TEST_IP = "BBBBBBBBBB";

    private static final String DEFAULT_EXTRA_TEST_IP = "AAAAAAAAAA";
    private static final String UPDATED_EXTRA_TEST_IP = "BBBBBBBBBB";
    ...
    public static Arm createEntity(EntityManager em) {
        Arm arm = new Arm()
            .name(DEFAULT_NAME)
            .prodIp(DEFAULT_PROD_IP)
            .extraProdIp(DEFAULT_EXTRA_PROD_IP)
            .testIp(DEFAULT_TEST_IP)
            .extraTestIp(DEFAULT_EXTRA_TEST_IP);
        return arm;
    }
    /**
    ...
    public static Arm createUpdatedEntity(EntityManager em) {
        Arm arm = new Arm()
            .name(UPDATED_NAME)
            .prodIp(UPDATED_PROD_IP)
            .extraProdIp(UPDATED_EXTRA_PROD_IP)
            .testIp(UPDATED_TEST_IP)
            .extraTestIp(UPDATED_EXTRA_TEST_IP);
        return arm;
    }
    ...
    public void createArm() throws Exception {
        ...
        assertThat(testArm.getProdIp()).isEqualTo(DEFAULT_PROD_IP);
        assertThat(testArm.getExtraProdIp()).isEqualTo(DEFAULT_EXTRA_PROD_IP);
        assertThat(testArm.getTestIp()).isEqualTo(DEFAULT_TEST_IP);
        assertThat(testArm.getExtraTestIp()).isEqualTo(DEFAULT_EXTRA_TEST_IP);
    ...
    public void getAllArms() throws Exception {
        ...
        restArmMockMvc.perform(get("/api/arms?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].prodIp").value(hasItem(DEFAULT_PROD_IP.toString())))
            .andExpect(jsonPath("$.[*].extraProdIp").value(hasItem(DEFAULT_EXTRA_PROD_IP.toString())))
            .andExpect(jsonPath("$.[*].testIp").value(hasItem(DEFAULT_TEST_IP.toString())))
            .andExpect(jsonPath("$.[*].extraTestIp").value(hasItem(DEFAULT_EXTRA_TEST_IP.toString())));
    }
    ...
    public void getArm() throws Exception {
        ...
        restArmMockMvc.perform(get("/api/arms/{id}", arm.getId()))
            ...
            .andExpect(jsonPath("$.prodIp").value(DEFAULT_PROD_IP.toString()))
            .andExpect(jsonPath("$.extraProdIp").value(DEFAULT_EXTRA_PROD_IP.toString()))
            .andExpect(jsonPath("$.testIp").value(DEFAULT_TEST_IP.toString()))
            .andExpect(jsonPath("$.extraTestIp").value(DEFAULT_EXTRA_TEST_IP.toString()));
    }
    ...
    public void updateArm() throws Exception {
        ...
        assertThat(testArm.getProdIp()).isEqualTo(UPDATED_PROD_IP);
        assertThat(testArm.getExtraProdIp()).isEqualTo(UPDATED_EXTRA_PROD_IP);
        assertThat(testArm.getTestIp()).isEqualTo(UPDATED_TEST_IP);
        assertThat(testArm.getExtraTestIp()).isEqualTo(UPDATED_EXTRA_TEST_IP);
    ...
    public void searchArm() throws Exception {
        ...
        restArmMockMvc.perform(get("/api/_search/arms?query=id:" + arm.getId()))
            ...
            .andExpect(jsonPath("$.[*].prodIp").value(hasItem(DEFAULT_PROD_IP)))
            .andExpect(jsonPath("$.[*].extraProdIp").value(hasItem(DEFAULT_EXTRA_PROD_IP)))
            .andExpect(jsonPath("$.[*].testIp").value(hasItem(DEFAULT_TEST_IP)))
            .andExpect(jsonPath("$.[*].extraTestIp").value(hasItem(DEFAULT_EXTRA_TEST_IP)));
    }
