...
public class RacfUserResourceIT {
    ...
    public void createRacfUser() throws Exception {
        ...
        assertThat(testRacfUser.getEsppRequest()).isEqualTo(DEFAULT_ESPP_REQUEST);
        assertThat(testRacfUser.getAsozRequest()).isEqualTo(DEFAULT_ASOZ_REQUEST);
    ...
    public void updateRacfUser() throws Exception {
        ...
        assertThat(testRacfUser.getEsppRequest()).isEqualTo(UPDATED_ESPP_REQUEST);
        assertThat(testRacfUser.getAsozRequest()).isEqualTo(UPDATED_ASOZ_REQUEST);
