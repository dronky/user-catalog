...
import com.zos.usercatalog.config.audit.AuditEventConverter;
import com.zos.usercatalog.domain.PersistentAuditEvent;
...
import static com.zos.usercatalog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
