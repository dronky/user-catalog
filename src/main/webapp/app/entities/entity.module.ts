...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'arm-ip',
        loadChildren: './arm-ip/arm-ip.module#UserCatalogArmIpModule'
      },
      {
        path: 'system',
        loadChildren: './system/system.module#UserCatalogSystemModule'
      },
      {
        path: 'owner',
      ...
      {
        path: 'request',
        loadChildren: './request/request.module#UserCatalogRequestModule'
      }
