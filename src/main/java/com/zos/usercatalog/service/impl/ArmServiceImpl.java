...
public class ArmServiceImpl implements ArmService {
     ...
     * @return the list of entities.
     */
    public Page<ArmDTO> findAllWithEagerRelationships(Pageable pageable) {
        return armRepository.findAllWithEagerRelationships(pageable).map(armMapper::toDto);
    }
    ...
    public Optional<ArmDTO> findOne(Long id) {
        ...
        return armRepository.findOneWithEagerRelationships(id)
            .map(armMapper::toDto);
    }
