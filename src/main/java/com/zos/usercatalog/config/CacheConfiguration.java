package com.zos.usercatalog.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.zos.usercatalog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.zos.usercatalog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.zos.usercatalog.domain.RacfUser.class.getName() + ".names");
            ...
            createCache(cm, com.zos.usercatalog.domain.Arm.class.getName() + ".armIps");
            createCache(cm, com.zos.usercatalog.domain.ArmIp.class.getName());
            createCache(cm, com.zos.usercatalog.domain.System.class.getName());
            createCache(cm, com.zos.usercatalog.domain.System.class.getName() + ".names");
