...
public class ArmResource {
     ...
     */
    @GetMapping("/arms")
    public ResponseEntity<List<ArmDTO>> getAllArms(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        log.debug("REST request to get a page of Arms");
        Page<ArmDTO> page = armService.findAll(pageable);
