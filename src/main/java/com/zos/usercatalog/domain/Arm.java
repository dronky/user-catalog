...
public class Arm implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "arm_arm_ip",
               joinColumns = @JoinColumn(name = "arm_id", referencedColumnName = "id"),
               inverseJoinColumns = @JoinColumn(name = "arm_ip_id", referencedColumnName = "id"))
